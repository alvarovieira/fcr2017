...
if("TRUE" STREQUAL "TRUE")
  set(fcr2017_SOURCE_PREFIX /home/aluno/catkin_ws/src/fcr2017)
  set(fcr2017_DEVEL_PREFIX /home/aluno/catkin_ws/devel)
  set(fcr2017_INSTALL_PREFIX "")
  set(fcr2017_PREFIX ${fcr2017_DEVEL_PREFIX})
else()
  set(fcr2017_SOURCE_PREFIX "")
  set(fcr2017_DEVEL_PREFIX "")
  set(fcr2017_INSTALL_PREFIX /home/aluno/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'fcr2017' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Gabriel Araujo <gabriel.araujo.5000@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'fcr2017' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aluno/catkin_ws/src/fcr2017/${idir}'.  Ask the maintainer 'Gabriel Araujo <gabriel.araujo.5000@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${fcr2017_dep}_FOUND)
      find_package(${fcr2017_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${fcr2017_dep} REQUIRED ${depend_list})
  endif()
